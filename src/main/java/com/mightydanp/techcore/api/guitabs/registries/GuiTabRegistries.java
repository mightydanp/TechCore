...
public class GuiTabRegistries {
    ...
    public static GuiTab playerInventory = new GuiTab("player_inventory");

    public static void init(){
        guiTabs.put(InventoryScreen.class, playerInventory = new InventoryGuiTab("player_inventory").setPriorityNumber(1));
    }
