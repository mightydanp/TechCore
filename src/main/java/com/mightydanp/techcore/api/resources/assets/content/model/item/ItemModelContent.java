package com.mightydanp.techcore.api.resources.assets.content.model.item;

import com.mightydanp.techcore.api.resources.assets.AssetPackRegistries;
import com.mightydanp.techcore.api.resources.assets.content.model.ModelContent;
...
public class ItemModelContent<A extends ItemModelContent<A>> extends ModelContent<A> {
    ...
    public ItemModelBuilder<A> basicItem(@NotNull ResourceLocation item) {
    ...
    private @NotNull ItemModelBuilder<A> addFlatFace(@NotNull ItemModelBuilder<A> model, Direction direction, String texture, int tintIndex, float z) {
        model.element()
                .from(0.0F, 0.0F, z)
                .to(16.0F, 16.0F, z)
                .shade(false)
    ...
    @Contract("_ -> param1")
    private @NotNull ItemModelBuilder<A> addGeneratedItemDisplay(@NotNull ItemModelBuilder<A> model) {
        model.transforms()
