...
public class MCItemModelContent extends ItemModelContent<MCItemModelContent> {
    ...
    //------------------------------------------------------------------------------------------------------------------
    public MCItemModelContent saveItem(@NotNull Map<Integer, ResourceLocation> textureMap) {
    ...
    //------------------------------------------------------------------------------------------------------------------
    public MCItemModelContent saveBlockItem(@NotNull MCBlockModelContent modelContent) {
        return this
