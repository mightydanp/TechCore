...
public class TCModelBuilder extends ModelFile{
    ...
    protected final TCModelBuilder.TransformsBuilder transforms = new TransformsBuilder();
    ...
    protected final List<TCModelBuilder.ElementBuilder> elements = new ArrayList<>();
     ...
     */
    public TCModelBuilder parent(ModelFile parent) {
        this.parent = parent;
        return this;
    }
     ...
     * @throws NullPointerException  if {@code parent} is {@code null}
     */
    public TCModelBuilder parent(ResourceLocation resourceLocation) {
     ...
     *                               known resource pack
     */
    public TCModelBuilder texture(String key, String texture) {
     ...
     *                               known resource pack
     */
    public TCModelBuilder texture(String key, ResourceLocation texture) {
        Preconditions.checkNotNull(key, "Key must not be null");
        Preconditions.checkNotNull(texture, "Texture must not be null");
     ...
     */
    public TCModelBuilder renderType(String renderType) {
     ...
     * @throws NullPointerException if {@code renderType} is {@code null}
     */
    public TCModelBuilder renderType(ResourceLocation renderType) {
        Preconditions.checkNotNull(renderType, "Render type must not be null");
        this.renderType = renderType.toString();
        return this;
    }

    public TCModelBuilder.TransformsBuilder transforms() {
        return transforms;
    }

    public TCModelBuilder ao(boolean ao) {
        this.ambientOcclusion = ao;
        return this;
    }

    public TCModelBuilder guiLight(BlockModel.GuiLight light) {
        this.guiLight = light;
        return this;
    }

    public TCModelBuilder.ElementBuilder element() {
        TCModelBuilder.ElementBuilder ret = new ElementBuilder();
        elements.add(ret);
        return ret;
    }
     ...
     */
    public TCModelBuilder.ElementBuilder element(int index) {
    ...
    public TCModelBuilder.RootTransformsBuilder rootTransforms() {
    ...
    public static class ElementBuilder {
        ...
        private final Map<Direction, TCModelBuilder.ElementBuilder.FaceBuilder> faces = new LinkedHashMap<>();
        private TCModelBuilder.ElementBuilder.RotationBuilder rotation;
         ...
         *                                  inclusive)
         */
        public TCModelBuilder.ElementBuilder to(float x, float y, float z) {
         ...
         */
        public TCModelBuilder.ElementBuilder.FaceBuilder face(Direction dir) {
            Preconditions.checkNotNull(dir, "Direction must not be null");
            return faces.computeIfAbsent(dir, TCModelBuilder.ElementBuilder.FaceBuilder::new);
        }

        public TCModelBuilder.ElementBuilder.RotationBuilder rotation() {
            if (this.rotation == null) {
                this.rotation = new TCModelBuilder.ElementBuilder.RotationBuilder();
            }
            return this.rotation;
        }

        public TCModelBuilder.ElementBuilder shade(boolean shade) {
            this.shade = shade;
            return this;
        }
         ...
         */
        public TCModelBuilder.ElementBuilder allFaces(BiConsumer<Direction, TCModelBuilder.ElementBuilder.FaceBuilder> action) {
         ...
         * @throws NullPointerException if {@code action} is {@code null}
         */
        public TCModelBuilder.ElementBuilder faces(BiConsumer<Direction, TCModelBuilder.ElementBuilder.FaceBuilder> action) {
         ...
         * @throws NullPointerException if {@code texture} is {@code null}
         */
        public TCModelBuilder.ElementBuilder textureAll(String texture) {
         ...
         * @throws NullPointerException if {@code texture} is {@code null}
         */
        public TCModelBuilder.ElementBuilder texture(String texture) {
         ...
         * @throws NullPointerException if {@code texture} is {@code null}
         */
        public TCModelBuilder.ElementBuilder cube(String texture) {
         ...
         * @return this builder
         */
        public TCModelBuilder.ElementBuilder emissivity(int blockLight, int skyLight) {
         ...
         * @return this builder
         */
        public TCModelBuilder.ElementBuilder color(int color) {
            this.color = color;
            return this;
        }
         ...
         * @return this builder
         */
        public TCModelBuilder.ElementBuilder ao(boolean ao) {
            this.hasAmbientOcclusion = ao;
            return this;
        }

        private BiConsumer<Direction, TCModelBuilder.ElementBuilder.FaceBuilder> addTexture(String texture) {
        ...
        public class FaceBuilder {
            ...
            private float[] uvs;
            private TCModelBuilder.FaceRotation rotation = TCModelBuilder.FaceRotation.ZERO;
            private int color = 0xFFFFFFFF;
            private int blockLight = 0, skyLight = 0;
            private boolean hasAmbientOcclusion = true;
            ...
            public TCModelBuilder.ElementBuilder.FaceBuilder cullface(@Nullable Direction dir) {
                this.cullface = dir;
                return this;
            }

            public TCModelBuilder.ElementBuilder.FaceBuilder tintindex(int index) {
             ...
             * @throws NullPointerException if {@code texture} is {@code null}
             */
            public TCModelBuilder.ElementBuilder.FaceBuilder texture(String texture) {
                Preconditions.checkNotNull(texture, "Texture must not be null");
             ...
             */
            public TCModelBuilder.ElementBuilder.FaceBuilder rotation(TCModelBuilder.FaceRotation rot) {
             ...
             * @return this builder
             */
            public TCModelBuilder.ElementBuilder.FaceBuilder emissivity(int blockLight, int skyLight) {
                this.blockLight = blockLight;
                this.skyLight = skyLight;
                return this;
            }
             ...
             * @return this builder
             */
            public TCModelBuilder.ElementBuilder.FaceBuilder color(int color) {
                this.color = color;
                return this;
            }
             ...
             * @return this builder
             */
            public TCModelBuilder.ElementBuilder.FaceBuilder ao(boolean ao) {
                this.hasAmbientOcclusion = ao;
                return this;
            }
            ...
            public TCModelBuilder.ElementBuilder end() {
                return TCModelBuilder.ElementBuilder.this;
            }
        }
        ...
        public class RotationBuilder {
            ...
            public TCModelBuilder.ElementBuilder.RotationBuilder origin(float x, float y, float z) {
             ...
             */
            public TCModelBuilder.ElementBuilder.RotationBuilder axis(Direction.Axis axis) {
             ...
             */
            public TCModelBuilder.ElementBuilder.RotationBuilder angle(float angle) {
            ...
            public TCModelBuilder.ElementBuilder.RotationBuilder rescale(boolean rescale) {
    ...
    public static class TransformsBuilder {
        ...
        private final Map<ItemDisplayContext, TCModelBuilder.TransformsBuilder.TransformVecBuilder> transforms = new LinkedHashMap<>();
         ...
         */
        public TCModelBuilder.TransformsBuilder.TransformVecBuilder transform(ItemDisplayContext type) {
            Preconditions.checkNotNull(type, "Perspective cannot be null");
            return transforms.computeIfAbsent(type, TCModelBuilder.TransformsBuilder.TransformVecBuilder::new);
        }
        ...
        public TCModelBuilder.TransformsBuilder end() {
            return TCModelBuilder.TransformsBuilder.this;
        }
        ...
        public class TransformVecBuilder {
            ...
            public TCModelBuilder.TransformsBuilder.TransformVecBuilder rotation(float x, float y, float z) {
                this.rotation = new Vector3f(x, y, z);
                return this;
            }

            public TCModelBuilder.TransformsBuilder.TransformVecBuilder leftRotation(float x, float y, float z) {
                return rotation(x, y, z);
            }

            public TCModelBuilder.TransformsBuilder.TransformVecBuilder translation(float x, float y, float z) {
                this.translation = new Vector3f(x, y, z);
                return this;
            }

            public TCModelBuilder.TransformsBuilder.TransformVecBuilder scale(float sc) {
                return scale(sc, sc, sc);
            }

            public TCModelBuilder.TransformsBuilder.TransformVecBuilder scale(float x, float y, float z) {
                this.scale = new Vector3f(x, y, z);
                return this;
            }

            public TCModelBuilder.TransformsBuilder.TransformVecBuilder rightRotation(float x, float y, float z) {
    ...
    public class RootTransformsBuilder {
         ...
         */
        public TCModelBuilder.RootTransformsBuilder translation(Vector3f translation) {
         ...
         * @return this builder
         */
        public TCModelBuilder.RootTransformsBuilder translation(float x, float y, float z) {
         ...
         */
        public TCModelBuilder.RootTransformsBuilder rotation(Quaternionf rotation) {
         ...
         * @return this builder
         */
        public TCModelBuilder.RootTransformsBuilder rotation(float x, float y, float z, boolean isDegrees) {
         ...
         */
        public TCModelBuilder.RootTransformsBuilder leftRotation(Quaternionf leftRotation) {
         ...
         * @return this builder
         */
        public TCModelBuilder.RootTransformsBuilder leftRotation(float x, float y, float z, boolean isDegrees) {
         ...
         */
        public TCModelBuilder.RootTransformsBuilder rightRotation(Quaternionf rightRotation) {
         ...
         * @return this builder
         */
        public TCModelBuilder.RootTransformsBuilder rightRotation(float x, float y, float z, boolean isDegrees) {
         ...
         * @throws NullPointerException if {@code rightRotation} is {@code null}
         */
        public TCModelBuilder.RootTransformsBuilder postRotation(Quaternionf postRotation) {
         ...
         * @return this builder
         */
        public TCModelBuilder.RootTransformsBuilder postRotation(float x, float y, float z, boolean isDegrees) {
         ...
         * @return this builder
         */
        public TCModelBuilder.RootTransformsBuilder scale(float scale) {
         ...
         * @return this builder
         */
        public TCModelBuilder.RootTransformsBuilder scale(float xScale, float yScale, float zScale) {
         ...
         */
        public TCModelBuilder.RootTransformsBuilder scale(Vector3f scale) {
         ...
         */
        public TCModelBuilder.RootTransformsBuilder transform(Transformation transformation) {
         ...
         */
        public TCModelBuilder.RootTransformsBuilder origin(Vector3f origin) {
         ...
         */
        public TCModelBuilder.RootTransformsBuilder origin(TransformationHelper.TransformOrigin origin) {
