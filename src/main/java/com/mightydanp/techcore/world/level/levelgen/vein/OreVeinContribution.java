...
public record OreVeinContribution(
        long instanceId,
    ...
    public OreVeinContribution {
        ...
        if (!Double.isFinite(localX)
                ...
                || !Double.isFinite(normalizedRadius)
                || !Double.isFinite(distortionBlocks)
                || !Double.isFinite(signedBoundaryDistanceBlocks)) {
