...
public final class OreVeinOreCellEvaluator {
    ...
    public record CellResultFactory(OreVeinInstanceDescriptor descriptor, SelectedOreEntry selectedOreEntry, OreVeinShapeEvaluator.ShapeContribution contribution) {
