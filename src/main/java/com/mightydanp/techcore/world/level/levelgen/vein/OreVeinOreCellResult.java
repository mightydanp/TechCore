...
public record OreVeinOreCellResult(long instanceId, ResourceLocation definitionId, Material selectedMaterial, int selectedDistributionWeight, OreVeinContribution shapeContribution, int candidateDensity, int finalDensity, OreVariant variant, long winningNodeId, double winningNodeInfluence) {
